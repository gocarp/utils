...
func doStruct(
	...
	if pointer == nil {
		return errors.NewCode(codes.CodeInvalidParameter, "object pointer cannot be nil")
	}
	...
	if priorityTag != "" {
		priorityTagArray = append(utils.SplitAndTrim(priorityTag, ","), tag.StructTagPriority...)
	} else {
		priorityTagArray = tag.StructTagPriority
	}
