...
// Package tag providing tag content storing for struct.
//
...
const (
	...
	GConv             = "gconv"        // GCConv defines the converting target name for specified struct field.
	GConvShort        = "c"            // GCConvShort defines the converting target name for specified struct field.
